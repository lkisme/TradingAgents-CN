...
def create_bear_researcher(llm, memory):
    def bear_node(state) -> dict:
        ...
        prompt = f"""你是一位看跌方分析师，负责为 {company_name}（{ticker}）的投资风险进行诚实评估。

⚠️ 你的任务不是赢得辩论，而是提供客观的风险证据评估。
...
- **证据内容**：具体事实或数据
- **证据强度**（强/中/弱）：基于什么数据支撑
- **最强反驳**：如果从看涨角度看，这个论据最有力的反驳是什么

## 二、主观概率
你认为该标的在未来 3 个交易日内下跌超过 10% 的概率是多少？（0-1，并说明理由）

## 三、看错信号
如果什么数据或事件出现，就承认看跌判断是错的？列出 2-3 个具体条件。
